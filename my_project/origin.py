...
from msg.msg import Message,ChatRequest,QueryResponse
...
builder = StructuredTaskStepStoryboard.form_builder(
    ...
    start_task_context="关于粒子群优化算法的相关原理",
...
def worker(
    ...
    try:
        ...
        return {
            "step": step,
            "task_step_name": task_engine.task_step_name,  # 假设有step_name属性
            "task_step_description": task_engine.task_step_description,  # 假设有step_description属性
            "task_step_level": task_engine.task_step_level,  # 假设有step_level属性
            "answer": answer
        }
...
if __name__ == "__main__":
    ...
    print("最终拼接结果:")
    print(result_string)
    summary = StructuredTaskStepStoryboard.generate_summary(llm_runable=llm, content=result_string)
    print("\n" + "=" * 60)
    print("结构化总结:")
    print("=" * 60)
    print(summary)
