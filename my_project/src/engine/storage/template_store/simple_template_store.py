...
from engine.storage.template_store.keyval_template_store import KVTemplateStore
from engine.storage.template_store.types import (
    DEFAULT_PERSIST_DIR,
...
class SimpleTemplateStore(KVTemplateStore):
    """Simple Template (Node) store.

    An in-memory store for Template and Node objects.
    ...
    def from_persist_dir(
        ...
        """Create a SimpleTemplateStore from a persist directory.
    ...
    def from_persist_path(
        ...
        """Create a SimpleTemplateStore from a persist path.
