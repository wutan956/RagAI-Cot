...
from vector.knowledge_base.kb_cache.faiss_cache import (
    ThreadSafeFaiss,
    kb_faiss_pool,
)
...
class FaissCollectionService(CollectionService):
    ...
    def __init__(
        ...
        self._vs_path = os.path.join(kb_name, "vector_store", vector_name) # 就是当前任务的路径：哈希值下面多了vector_store/samples的路径，用来存储向量库的
